...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="col-md-6">
            <div class="radio inline">
                    <input type="radio" id="radio-4" name="status" value="Admin" >
                    <label for="radio-4" class="radio-label">Admin</label>
                </div>
                <div class="radio inline">
                    <input type="radio" id="radio-5" name="status" value="User" >
                    <label for="radio-5" class="radio-label">User</label>
                </div>
            </div>
